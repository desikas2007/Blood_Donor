...
export default function HospitalProfilePage() {
  ...
  useEffect(() => {
    ...
    getMyRequesterProfile()
      ...
      .catch(() => setError("Could not load your hospital profile. Please re-login."))
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-page-title text-dark">Hospital Profile</h1>
          <p className="text-[15px] text-muted mt-1">Manage your hospital information.</p>
        </div>
        {!editing && (
        ...
        <div className="bg-white border border-border rounded-lg p-6">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              ...
              <p className="text-[13px] text-muted capitalize">Hospital</p>
            </div>
          </div>
